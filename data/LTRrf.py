...
#use random forest
svm_model = RandomForestClassifier(probability = True)
...
plt.title('Receiver Operating Characteristic (ROC) - Class 0 - LTR - RF')
...
plt.plot(mean_predicted_value, fraction_of_positives, "s-", label="RF", color = 'magenta')
plt.plot([0, 1], [0, 1], "k--", label="Perfectly calibrated")
plt.xlabel("Mean predicted probability",fontsize = 14)
plt.ylabel("Fraction of positives",fontsize = 14)
plt.title("Calibration plot - RF", fontsize = 16)
