...
plt.savefig('/Users/silke/Documents/masterthesis/Results/2LTRclassifier/ltr_rf_roc_curve.pdf')
plt.show()
...
plt.figure()
plt.plot(mean_predicted_value, fraction_of_positives, "s-", label="Random Forest", color = 'magenta')
...
plt.legend(loc="lower right")
# Save the plot as a PDF
plt.savefig('/Users/silke/Documents/masterthesis/Results/2LTRclassifier/ltr_rf_calibration.pdf')
plt.show()
...
with open('LTRacc_runtime_RF.txt', 'w') as f:  # 'f' is defined within this block
    for item in tosave:
        f.write(f"{item}\n")

with open('LTRfpr_RF.txt', 'w') as f:  # 'f' is defined within this block
    for item in fpr:
        f.write(f"{item}\n")

with open('LTRtpr_RF.txt', 'w') as f:  # 'f' is defined within this block
    for item in tpr:
        f.write(f"{item}\n")
