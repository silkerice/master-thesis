...
X_train, X_test, y_train, y_test = train_test_split(shuffled_data.images, shuffled_data.targets, test_size=0.7, random_state=42)
...
# Rotate the tensor
rotated_tensor = tf.transpose(X_train_rescaled,perm=[0, 2, 1, 3])

X_train_rescaled =  tf.concat([X_train_rescaled, rotated_tensor],axis = 0)
